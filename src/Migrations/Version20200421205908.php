...
final class Version20200421205908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS movies (id INT AUTO_INCREMENT NOT NULL, genre VARCHAR(255) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, release_date DATE DEFAULT NULL, duration VARCHAR(15) DEFAULT NULL, description LONGTEXT DEFAULT NULL, url_trailer LONGTEXT DEFAULT NULL, week_number VARCHAR(2) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
